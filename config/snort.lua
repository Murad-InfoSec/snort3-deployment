...
-- Load Snort default variables and settings
...
ips =
{
    -- run in IDS mode (read-only). Use 'inline' if you do IPS.
    mode = 'tap',

    -- Snort default variables from snort_defaults.lua
    variables = default_variables,

    -- enable internal/builtin decoder & inspector alerts (optional)
